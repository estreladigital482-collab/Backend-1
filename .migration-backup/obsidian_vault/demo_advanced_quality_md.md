---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_advanced_quality.md
filename: demo_advanced_quality.md
---

# demo_advanced_quality.md

---
category: Integração
source: packages/bridge/demo_advanced_quality.py
created: 2026-05-05T19:45:45.740168
size: 5452 bytes
hash: 347751392779687c79bdd1881c66d43c
headers:
  - Configurar logging
---

# demo_advanced_quality.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_advanced_quality.py`
- **Tamanho**: 5452 bytes
...
#!/usr/bin/env python3
"""
Demo do Sistema Avançado de Avaliação de Qualidade
================================================

Demonstração das funcionalidades avançadas de avaliação da IA.
"""

import asyncio
import logging
from pathlib import Path
from agent.advanced_quality_evaluator import AdvancedQualityEvaluator
from agent.quality_metrics import QualityMetricsCollector
...
async def demo_advanced_quality_evaluation():
    ...
    print("🚀 Iniciando demo do sistema avançado de avaliação de qualidade...")
