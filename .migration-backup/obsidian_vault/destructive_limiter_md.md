---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/destructive_limiter.md
filename: destructive_limiter.md
---

# destructive_limiter.md

---
category: Integração
source: packages/bridge/agent/destructive_limiter.py
created: 2026-05-05T19:45:45.741168
size: 14000 bytes
hash: 8ef3ff0c8def915a8ecba23ed74ee8a2
headers:
---

# destructive_limiter.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/destructive_limiter.py`
- **Tamanho**: 14000 bytes
