---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_quality_isolated.md
filename: demo_quality_isolated.md
---

# demo_quality_isolated.md

---
category: Integração
source: packages/bridge/demo_quality_isolated.py
created: 2026-05-05T19:45:45.740168
size: 6217 bytes
hash: 78bc27e45ffe109f3dd80e694fc2e8e5
headers:
...
# demo_quality_isolated.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_quality_isolated.py`
- **Tamanho**: 6217 bytes
