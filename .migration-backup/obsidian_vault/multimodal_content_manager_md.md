---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/multimodal_content_manager.md
filename: multimodal_content_manager.md
---

# multimodal_content_manager.md

---
category: Integração
source: packages/bridge/agent/multimodal_content_manager.py
created: 2026-05-05T19:45:45.741168
size: 22458 bytes
hash: 5760f4cd1695078f6362cdeec835ffc8
headers:
---

# multimodal_content_manager.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/multimodal_content_manager.py`
- **Tamanho**: 22458 bytes
