---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/curriculum_manager.md
filename: curriculum_manager.md
---

# curriculum_manager.md

---
category: Integração
source: packages/bridge/agent/learning/curriculum_manager.py
created: 2026-05-05T19:45:45.741168
size: 3396 bytes
hash: 45da862d0ef7355a669a4caec8cbc51c
headers:
---
...
- **Caminho Original**: `packages/bridge/agent/learning/curriculum_manager.py`
- **Tamanho**: 3396 bytes
