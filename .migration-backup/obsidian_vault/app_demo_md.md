---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/app_demo.md
filename: app_demo.md
---
...
---
category: Integração
source: packages/bridge/app_demo.py
created: 2026-05-05T19:45:45.741168
size: 5975 bytes
hash: 24d9520625c2221efeda5ef60996d3bd
headers:
  - Initialize database
...
- **Caminho Original**: `packages/bridge/app_demo.py`
- **Tamanho**: 5975 bytes
