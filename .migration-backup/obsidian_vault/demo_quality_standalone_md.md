---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_quality_standalone.md
filename: demo_quality_standalone.md
---

# demo_quality_standalone.md

---
category: Integração
source: packages/bridge/demo_quality_standalone.py
created: 2026-05-05T19:45:45.740168
size: 13545 bytes
hash: d30f4c26b7b904d3d08ffd271ee5c318
headers:
  - Configurar logging
  - Copiar classes necessárias diretamente
---

# demo_quality_standalone.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_quality_standalone.py`
- **Tamanho**: 13545 bytes
