---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/rules.md
filename: rules.md
---
...
---
category: Integração
source: packages/bridge/data/governance/rules.json
created: 2026-05-05T19:45:45.742168
size: 2141 bytes
hash: d2d4f2b6173354e23fd8f085cc95c706
headers:
---
...
- **Caminho Original**: `packages/bridge/data/governance/rules.json`
- **Tamanho**: 2141 bytes
