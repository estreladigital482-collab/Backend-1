---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_adaptive_learning_simple.md
filename: demo_adaptive_learning_simple.md
---

# demo_adaptive_learning_simple.md

---
category: Integração
source: packages/bridge/demo_adaptive_learning_simple.py
created: 2026-05-05T19:45:45.741168
size: 5964 bytes
hash: 19c28328315749a0da26daad6510f2ed
headers:
  - Adicionar o caminho do bridge ao sys.path
---

# demo_adaptive_learning_simple.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_adaptive_learning_simple.py`
- **Tamanho**: 5964 bytes
