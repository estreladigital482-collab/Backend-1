---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/learning_controller.md
filename: learning_controller.md
---

# learning_controller.md

---
category: Integração
source: packages/bridge/agent/learning/learning_controller.py
created: 2026-05-05T19:45:45.741168
size: 4123 bytes
hash: 91fd98a61501a4a6b04d8259bada3a6f
headers:
---
...
- **Caminho Original**: `packages/bridge/agent/learning/learning_controller.py`
- **Tamanho**: 4123 bytes
