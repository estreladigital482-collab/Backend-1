---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/controlled_learning.md
filename: controlled_learning.md
---

# controlled_learning.md

---
category: Integração
source: packages/bridge/agent/controlled_learning.py
created: 2026-05-05T19:45:45.741168
size: 11619 bytes
hash: fa02f2767556b9c5ddb03fe1b50bb65c
headers:
---

# controlled_learning.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/controlled_learning.py`
- **Tamanho**: 11619 bytes
