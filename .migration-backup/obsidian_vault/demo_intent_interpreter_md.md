---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_intent_interpreter.md
filename: demo_intent_interpreter.md
---

# demo_intent_interpreter.md

---
category: Integração
source: packages/bridge/demo_intent_interpreter.py
created: 2026-05-05T19:45:45.740168
size: 6497 bytes
hash: e62c8c6dcd097819e3220cc00fc0b1d9
headers:
  - Configurar logging
---

# demo_intent_interpreter.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_intent_interpreter.py`
- **Tamanho**: 6497 bytes
