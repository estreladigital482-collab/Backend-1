---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/image_editing_system.md
filename: image_editing_system.md
---

# image_editing_system.md

---
category: Integração
source: packages/bridge/agent/image_editing_system.py
created: 2026-05-05T19:45:45.740168
size: 13072 bytes
hash: be1ce9c828a306d7bd83ee974d206adb
headers:
---

# image_editing_system.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/image_editing_system.py`
- **Tamanho**: 13072 bytes
