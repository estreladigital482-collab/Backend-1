---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/openjarvis_adapter.md
filename: openjarvis_adapter.md
---

# openjarvis_adapter.md

---
category: Integração
source: packages/bridge/agent/openjarvis_adapter.py
created: 2026-05-05T19:45:45.741168
size: 5517 bytes
hash: 69dcb915d9febbb23480c5780eef3236
headers:
  - Adicionar caminho do OpenJarvis
---

# openjarvis_adapter.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/openjarvis_adapter.py`
- **Tamanho**: 5517 bytes
