---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_anomaly_standalone.md
filename: demo_anomaly_standalone.md
---

# demo_anomaly_standalone.md

---
category: Integração
source: packages/bridge/demo_anomaly_standalone.py
created: 2026-05-05T19:45:45.740168
size: 25775 bytes
hash: 1935989fe035f02ebdf12a7d76c8dc66
headers:
  - Configurar logging
  - Copiar classes necessárias diretamente
---

# demo_anomaly_standalone.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_anomaly_standalone.py`
- **Tamanho**: 25775 bytes
