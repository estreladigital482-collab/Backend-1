---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/sandbox_cleanup_optimizer.md
filename: sandbox_cleanup_optimizer.md
---

# sandbox_cleanup_optimizer.md

---
category: Integração
source: packages/bridge/agent/sandbox_cleanup_optimizer.py
created: 2026-05-05T19:45:45.740168
size: 18553 bytes
hash: 04d78c66cd32096e35d21e24c98a6a40
headers:
---

# sandbox_cleanup_optimizer.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/agent/sandbox_cleanup_optimizer.py`
- **Tamanho**: 18553 bytes
