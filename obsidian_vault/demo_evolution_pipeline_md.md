---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_evolution_pipeline.md
filename: demo_evolution_pipeline.md
---

# demo_evolution_pipeline.md

---
category: Integração
source: packages/bridge/demo_evolution_pipeline.py
created: 2026-05-05T19:45:45.742168
size: 3041 bytes
hash: 58fa2edbd6d34f5a3cf053a386d9c84e
headers:
  - Adicionar o diretório do projeto ao path
  - Teste da nova funcionalidade
---

# demo_evolution_pipeline.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_evolution_pipeline.py`
- **Tamanho**: 3041 bytes
