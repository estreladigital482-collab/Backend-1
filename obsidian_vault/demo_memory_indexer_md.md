---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_memory_indexer.md
filename: demo_memory_indexer.md
---

# demo_memory_indexer.md

---
category: Integração
source: packages/bridge/demo_memory_indexer.py
created: 2026-05-05T19:45:45.740168
size: 4532 bytes
hash: a50a46921b5c590c8eca5625b7960e44
headers:
  - Configurar logging
---

# demo_memory_indexer.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_memory_indexer.py`
- **Tamanho**: 4532 bytes
