---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_adaptive_learning_integration.md
filename: demo_adaptive_learning_integration.md
---

# demo_adaptive_learning_integration.md

---
category: Integração
source: packages/bridge/demo_adaptive_learning_integration.py
created: 2026-05-05T19:45:45.741168
size: 5997 bytes
hash: b7f5403944521cf198f16d256ef3c6b6
headers:
  - Adicionar o caminho do bridge ao sys.path
---

# demo_adaptive_learning_integration.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_adaptive_learning_integration.py`
- **Tamanho**: 5997 bytes
