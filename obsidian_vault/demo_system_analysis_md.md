---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_system_analysis.md
filename: demo_system_analysis.md
---

# demo_system_analysis.md

---
category: Integração
source: packages/bridge/demo_system_analysis.py
created: 2026-05-05T19:45:45.740168
size: 7832 bytes
hash: 4d420308ced3ff329aeb9a27739b61c8
headers:
...
# demo_system_analysis.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_system_analysis.py`
- **Tamanho**: 7832 bytes
