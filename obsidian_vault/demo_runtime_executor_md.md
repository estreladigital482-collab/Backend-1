---
source: /workspaces/Aura-sphere-/knowledge_vault/Integração/demo_runtime_executor.md
filename: demo_runtime_executor.md
---

# demo_runtime_executor.md

---
category: Integração
source: packages/bridge/demo_runtime_executor.py
created: 2026-05-05T19:45:45.740168
size: 1149 bytes
hash: aec116297fc78d2c6c0bdc938aa62d8e
headers:
  - Adicionar o diretório do projeto ao path
---

# demo_runtime_executor.py

## Metadados
- **Categoria**: Integração
- **Caminho Original**: `packages/bridge/demo_runtime_executor.py`
- **Tamanho**: 1149 bytes
