const VOICE_OPTIONS = [
  { id: "pt-female", label: "Aurora (PT-BR feminina)", lang: "pt-BR", gender: "female" as const },
  { id: "pt-male", label: "Atlas (PT-BR masculino)", lang: "pt-BR", gender: "male" as const },
  { id: "en-female", label: "Nova (EN feminina)", lang: "en-US", gender: "female" as const },
  { id: "en-male", label: "Orion (EN masculino)", lang: "en-US", gender: "male" as const },
];

export type VoiceId = (typeof VOICE_OPTIONS)[number]["id"];

export function getVoiceConfig(voiceId: string | null) {
  return VOICE_OPTIONS.find((v) => v.id === voiceId) ?? VOICE_OPTIONS[0];
}

export function speak(text: string, voiceId: string | null, onEnd?: () => void) {
